...
npm run start -- -i $1 -p 32767   -q 65535 -r "CVS Health" -s "CSV"
npm run start -- -i $1 -p 32767   -q 65535 -r "Ace Hardware" -s "ACE"
npm run start -- -i $1 -p 32767   -q 65535 -r "Dunkin Donuts" -s "DD"
npm run start -- -i $1 -p 32767   -q 65535 -r "United Parcel Service" -s "UPS"
